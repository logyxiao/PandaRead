...
pub struct AppSession {
    pub left_document_id: Option<String>,
    pub right_document_id: Option<String>,
    pub split: bool,
    pub split_ratio: f64,
...
pub struct AppSnapshot {
    ...
    pub materials: Vec<MaterialClip>,
